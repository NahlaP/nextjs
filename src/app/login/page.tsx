  ...
  const onLogin = async () => {
    try {
      ...
      if (axios.isAxiosError(error)) {
        ...
        toast.error(error.response?.data?.message || error.message); // Better error message handling
      } else {
      ...
      <div className="flex flex-col w-full max-w-md space-y-4">
        ...
        <div className="flex justify-center">
          <button
            ...
            className={`w-40 font-semibold py-2 rounded-lg mt-6 mb-10 transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-100 ${
              buttonDisabled
